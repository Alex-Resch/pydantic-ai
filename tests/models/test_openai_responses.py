                ...
                content=cast(
                    ...
                    [
                        ResponseOutputText(
                            text='Here are your files.',
                            type='output_text',
                            annotations=cast(list[Any], [annotation_1, annotation_2]),
                        )
                    ],
                ),
                role='assistant',
...
async def test_openai_code_execution_download_mixed_annotations_stream(allow_model_requests: None):
    """Streaming: url_citation annotations should be skipped, only container_file_citation downloaded."""
    from openai.types import responses as resp
    from openai.types.responses import (
        ResponseContentPartAddedEvent,
        ResponseOutputItemDoneEvent,
    ...
    stream: list[resp.ResponseStreamEvent] = [
        ...
        ResponseTextDeltaEvent(
            content_index=0,
            delta='Here is a file and a link.',
            item_id='msg_001',
            output_index=0,
            type='response.output_text.delta',
            logprobs=[],
        ...
        ResponseOutputTextAnnotationAddedEvent(
            annotation=cast(Annotation, cast(object, url_annotation)),
            annotation_index=0,
            content_index=0,
            item_id='msg_001',
            output_index=0,
        ...
        ResponseOutputTextAnnotationAddedEvent(
            annotation=cast(Annotation, cast(object, file_annotation)),
            annotation_index=1,
            content_index=0,
            item_id='msg_001',
            output_index=0,
